<?php
	...
	$validation_messages = array(
		...
		'full_name' => array(
			...
			'Enter a name that is less than 40 characters in length and consists only of letters and spaces.',
			'Enter a name that is less than 40 characters in length.',
			'Enter a name that consists only of letters and spaces.'
		),
			
		'email' => array(
			'Enter your email address in the email field.',
			'Enter a valid email address.',
			'Enter an email address that isn\'t yet registered with us.'
		),
			
		'inquiry' => array(
			'Enter your inquiry in the inquiry field.',
			'Enter an inquiry that is less than 500 characters in length.'
		)
	...
	function print_then_clear_all_validation_messages() {
		if(!empty($_SESSION['validation_messages'])) {
			echo "<!-- form validation messages -->
				<section id='validation-messages' class='clearfix'>
				<hr>
				<span class='pre-block block'>Please correct the following:</span>";
